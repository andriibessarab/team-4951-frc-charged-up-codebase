...
public final class Gyroscope {
    ...
    /**
     * Calculates and returns the current pitch angle of the robot using the
     * arctangent function and data from the gyro's accelerometer.
     * 
    ...
    /**
     * Calculates and returns the current thresholded pitch angle of the robot using
     * the arctangent function and data from the gyro's accelerometer.
     * 
